<template>
    <div class="search-box">
        ...
        <div class="radioBtn">
            <input type="radio" value="" name="type" v-model="searchKey.type" @change="searchOrder" checked />전체
            <input type="radio" value="ing" name="type" v-model="searchKey.type" @change="searchOrder" />배송중
            <input type="radio" value="done" name="type" v-model="searchKey.type" @change="searchOrder" />배송완료
        </div>
    </div>
</template>
