...
const orderInsert = () => {
    axios
        .post("/api/business/OrderInsert.do", {
            item_code: props.orderList.item_code,
            product_name: props.orderList.item_name,
            obtain_date: props.orderList.obtain_date,
            order_count: props.orderList.order_count,
